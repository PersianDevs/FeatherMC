...
public class SimpleCommandMap implements CommandMap {
    ...
    public boolean register(String label, String fallbackPrefix, Command command) {
        ...
        if (!registered) {
//            command.setLabel(fallbackPrefix + ":" + label); // Old
            // FeatherMC Start - set the command to command instead of "pluginName:command"
    ...
    private synchronized boolean register(String label, Command command, boolean isAlias, String fallbackPrefix) {
        knownCommands.put(label, command); // FeatherMC - set the command to command instead of "pluginName:command"
