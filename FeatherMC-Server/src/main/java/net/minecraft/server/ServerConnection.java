        ...
        synchronized (this.listeningChannels) { // Nacho - deobfuscate listeningChannels
...

            {
                switch (eventGroupType) {
                    default:
                    case DEFAULT: {
//                        LOGGER.info("Finding best event group type using fall-through"); // FeatherMC - removed useless logs
                    }
...
//                        LOGGER.info("Using NIO"); // FeatherMC - removed useless logs
            ...
            // FeatherMC Start - removed useless logs
...
//            LOGGER.info("Nacho: Using " + Natives.cipher.getLoadedVariant() + " cipher from Velocity.");
    ...
    public void stopServer() throws InterruptedException {
        this.started = false;
//        LOGGER.info("Shutting down event loops"); // FeatherMC - Removed useless logs
