...
public abstract class MinecraftServer implements Runnable, ICommandListener, IAsyncTaskHandler, IMojangStatistics {
    ...
    protected void k() {
        ...
        for (int m = 0; m < worlds.size(); m++) {
            ...
            LOGGER.info("Dar Hale Load Kardane Levele " + m + " (Seed: " + worldserver.getSeed() + ")"); // FeatherMC
            ...
            for (int k = -192; k <= 192 && this.isRunning(); k += 16) {
                for (int l = -192; l <= 192 && this.isRunning(); l += 16) {
                    ...
                    if (i1 - j > 1000L) {
//                        this.a_("Preparing spawn area", i * 100 / 625); // FeatherMC
                        j = i1;
                    }
...
//                        MinecraftServer.LOGGER.info("Saving chunks for level \'" + worldserver.getWorldData().getName() + "\'/" + worldserver.worldProvider.getName());
    ...
    public void stop() throws ExceptionWorldConflict, InterruptedException { // CraftBukkit - added throws
        ...
        // CraftBukkit end
        if (!this.N) {
//            MinecraftServer.LOGGER.info("Stopping server"); // FeatherMC - Removed useless logs
            ...
            if (this.playerList != null) { // Nacho - deobfuscate playerList
                MinecraftServer.LOGGER.info("Dar Hale Save Kardan Player Ha");
            ...
            if (this.worldServer != null) {
                MinecraftServer.LOGGER.info("Dar Hale Save Kardan World Ha");
...
//        this.methodProfiler.b();
    ...
    public String getServerModName() {
        return NachoConfig.serverBrandName; // FeatherMC - FeatherMC > // NachoSpigot - NachoSpigot >  // TacoSpigot - TacoSpigot // PaperSpigot - PaperSpigot > // Spigot - Spigot > // CraftBukkit - cb > vanilla!
    }
