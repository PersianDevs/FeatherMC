...
public class PlayerConnection implements PacketListenerPlayIn, IUpdatePlayerListBox {
    ...
    public void disconnect(String s) {
        ...
        String leaveMessage = EnumChatFormat.YELLOW + this.player.getName() + " Az Server Kharej Shod";
    ...
    public void a(IChatBaseComponent ichatbasecomponent) {
        ...
        // CraftBukkit end
//        PlayerConnection.c.info(this.player.getName() + " lost connection: " + ichatbasecomponent.c()); // CraftBukkit: Don't toString(). // PAIL: Rename // FeatherMC - Removed useless logs
