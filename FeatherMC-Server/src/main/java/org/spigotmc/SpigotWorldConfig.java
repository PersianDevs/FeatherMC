...
//        log("-------- World Settings For [" + worldName + "] --------"); // FeatherMC - removed useless logs
    ...
    private int getAndValidateGrowth(String crop) {
        int modifier = getInt("growth." + crop.toLowerCase() + "-modifier", -1);
        if (modifier == 0) {
    ...
    private void mobSpawnRange() {
        mobSpawnRange = (byte) getInt("mob-spawn-range", -1);
    ...
    private void structureInfo() {
        saveStructureInfo = getBoolean("save-structure-info", false);
    ...
    private void initHunger() {
        ...
        // FeatherMC - removed hunger

        walkExhaustion = (float) getDouble("hunger.walk-exhaustion", -1);
        sprintExhaustion = (float) getDouble("hunger.sprint-exhaustion", -1);
        combatExhaustion = (float) getDouble("hunger.combat-exhaustion", -1);
        regenExhaustion = (float) getDouble("hunger.regen-exhaustion", -1);
    ...
    private void maxTickTimes() {
        ...
        // FeatherMC start - Added Paper's tick time
