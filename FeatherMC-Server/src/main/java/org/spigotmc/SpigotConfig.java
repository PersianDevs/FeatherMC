...
//        Bukkit.getLogger().log( Level.INFO, "Using {0} threads for Netty based IO", count );  // FeatherMC - removed useless logs
    }
...
//        System.out.println( "Server Ping Player Sample Count: " + playerSample); // FeatherMC - removed useless logs
    }
