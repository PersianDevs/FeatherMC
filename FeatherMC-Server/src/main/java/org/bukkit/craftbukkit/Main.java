    ...
    public static void main(String[] args) {
        ...
        try {
            if (!SystemUtils.isJavaVersionAtLeast(JavaVersion.JAVA_17)) {
                System.err.println("Be Nazar Mirese Ke Az Java 17 Estefade Nemikoni");
                System.out.println("Behet Java 17 Ro Pishnahad Mikonam");
            }
        } catch (Exception ignored) {
            System.err.println("Khata Dar Gereftane Java, Mohem Nist Edame Midim...");
        }
        ...
        if ((options == null) || (options.has("?"))) {
            ...
            try {
                ...
                System.out.println("Made with love by Sxhqil (Discord: discord.gg/4F7QZFFpQY)");
                System.out.println("Dar Hale Load Kardane Library Ha, Lotfan Kamy Sabr Konid..."); // FeatherMC
