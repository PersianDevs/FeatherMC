...
public class PaperConfig
{
    ...
    /* FeatherMC - Removed useless header
    ...
    */
    ...
    public static void init(File configFile)
    {
        ...
        {
            Bukkit.getLogger().log( Level.SEVERE, "Moshkel Dar Load Shodane Confige paper.yml, Lotfan Confige Khod Ra Barresy Konid.", ex );
            throw Throwables.propagate( ex );
        }
//        config.options().header( HEADER ); FeatherMC
    ...
    protected static void fatal(String s) {
        throw new RuntimeException("Error Dar Confige paper.yml Rokh Dad: " + s);
    }
    ...
    static void readConfig(Class<?> clazz, Object instance)
    {
        ...
        {
            Bukkit.getLogger().log( Level.SEVERE, "Khata Dar Save Kardane " + CONFIG_FILE, ex );
        }
    }
...
//        Bukkit.getLogger().info( "Data value allowed items: " + StringUtils.join(dataValueAllowedItems, ", ") ); // FeatherMC - removed useless logs
    }
